...
corpusRaw <- Corpus(DirSource(c("text_files", "code_files")), readerControl = list(reader = readPlain, language = "en", load = TRUE))
...
write.table(as.data.frame(Topic), "output/CodeTopic.txt", sep="\t")
